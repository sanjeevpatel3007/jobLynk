...
const Footer = () => {
  return (
    <footer className="border-t border-gray-200 py-8 dark:bg-gray-800   bg-gray-800 dark:text-white text-white">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            {/* <h2 className="text-xl font-bold">JobLynk</h2> */}
...
<br />
            ...
            <p>Empower your career journey with JobLynk.
               Thousands of professionals have found their ideal job 
               with us—join them today!</p>
               <br />
            <p className="text-sm">© 2024 JobLynk. All rights reserved.</p>
          </div>
